...
public class FangwuEntity<T> implements Serializable {
	...
	@DateTimeFormat
    @TableField(value = "fangwu_time",fill = FieldFill.UPDATE)
    ...
    public String toString() {
        return "Fangwu{" +
            ...
            ", fangwuHuxingTypes=" + fangwuHuxingTypes +
            ", fangwuWeizhi=" + fangwuWeizhi +
            ", fangwuTedian=" + fangwuTedian +
            ", fangwuTime=" + fangwuTime +
            ", fangwuPhoto=" + fangwuPhoto +
            ", fangwuNewMoney=" + fangwuNewMoney +
            ", fangwuPingmi=" + fangwuPingmi +
            ", fangwuNumber=" + fangwuNumber +
