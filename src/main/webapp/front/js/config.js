...
var centerMenu = [
    ...
    ,{
        name: '房屋收藏',
        url: '../fangwuCollection/list.jsp'
    }
    ,{
        name: '房屋订单',
        url: '../fangwuOrder/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '楼盘介绍',
        url: './pages/singleSeach/detail.jsp?id=1'
    },
    {
        name: '公司介绍',
        url: './pages/singleSeach/detail.jsp?id=2'
    },
    {
        name: '房屋',
        url: './pages/fangwu/list.jsp'
    },
    {
        name: '新闻',
...
var adminurl =  "http://localhost:8080/loufangxiaoshouxitong/index.jsp";
