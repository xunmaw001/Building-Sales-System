              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">订单类型:</span>
                        <div class="layui-input-inline">
                            <select name="fangwuOrderTypes" id="fangwuOrderTypes" lay-filter="fangwuOrderTypes" style="width: 600px;">
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">预约看房时间:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="fangwuOrderTime" id="fangwuOrderTime"  placeholder="预约看房时间"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
