            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">客户展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="kehuName" id="kehuName" placeholder="姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="kehuPhone" id="kehuPhone" placeholder="手机号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="kehuIdNumber" id="kehuIdNumber" placeholder="身份证号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 kehuContent 字段去除无用字符 如果字段长度大于60  就截取到60
            kehuContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#kehuName').val() != null && jquery('#kehuName').val() != "" && jquery('#kehuName').val() != "null" ) {
                param['kehuName'] = jquery('#kehuName').val();
            }
         
            if (jquery('#kehuPhone').val() != null && jquery('#kehuPhone').val() != "" && jquery('#kehuPhone').val() != "null" ) {
                param['kehuPhone'] = jquery('#kehuPhone').val();
            }
         
            if (jquery('#kehuIdNumber').val() != null && jquery('#kehuIdNumber').val() != "" && jquery('#kehuIdNumber').val() != "null" ) {
                param['kehuIdNumber'] = jquery('#kehuIdNumber').val();
            }
                                    // 获取列表数据
            http.request('kehu/list', 'get', param, function(res) {
