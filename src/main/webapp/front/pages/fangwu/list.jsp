            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">房屋展示</span>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../fangwu/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../fangwu/detail.jsp?id='+item.id)"><span>{{item.fangwuName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 fangwuContent 字段去除无用字符 如果字段长度大于60  就截取到60
            fangwuContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#fangwuPingmiEnd').val() != null && jquery('#fangwuPingmiEnd').val() != "" && jquery('#fangwuPingmiEnd').val() != "null" ) {
                param['fangwuPingmiEnd'] = jquery('#fangwuPingmiEnd').val();
                                    ...
                                    // 获取列表数据
            http.request('fangwu/list', 'get', param, function(res) {
        ...
        function dateTimePick(){
            ...
            */
        // 交房日期的开始时间和结束时间的效验及格式
        var fangwuTimeStart = laydate.render({
            elem: '#fangwuTimeStart'
            ,type: 'datetime'
            ,done: function (value, dates) {
                fangwuTimeEnd.config.min={
                    year:dates.year,
        ...
        var fangwuTimeEnd = laydate.render({
            elem: '#fangwuTimeEnd'
            ,type: 'datetime'
            ,done: function (value, dates) {
                fangwuTimeStart.config.max={
                    year:dates.year,
                    month:dates.month-1,//关键
                    date: dates.date,
                    hours:dates.hours,
