            ...
            <form class="layui-form login-form">
              ...
              <div class="layui-form-item input">
                <div class="layui-input-block" style="text-align: left;margin-left: 0;">
                  <%--<input type="radio" name="role"  value="yonghu" title="员工">--%>
                  <input type="radio" name="role"  value="kehu" title="客户">
                </div>
              </div>
              ...
              <%--<a class="bottom-text-w3ls" href="javascript:registerClick('yonghu')">注册员工</a>--%>
              <a class="bottom-text-w3ls" href="javascript:registerClick('kehu')">注册客户</a>
            </form>
          </article>
        </div>
      </div>
