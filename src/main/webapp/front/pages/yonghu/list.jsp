            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">员工展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="yonghuName" id="yonghuName" placeholder="姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="yonghuPhone" id="yonghuPhone" placeholder="手机号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="yonghuIdNumber" id="yonghuIdNumber" placeholder="身份证号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 yonghuContent 字段去除无用字符 如果字段长度大于60  就截取到60
            yonghuContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#yonghuName').val() != null && jquery('#yonghuName').val() != "" && jquery('#yonghuName').val() != "null" ) {
                param['yonghuName'] = jquery('#yonghuName').val();
            }
         
            if (jquery('#yonghuPhone').val() != null && jquery('#yonghuPhone').val() != "" && jquery('#yonghuPhone').val() != "null" ) {
                param['yonghuPhone'] = jquery('#yonghuPhone').val();
            }
         
            if (jquery('#yonghuIdNumber').val() != null && jquery('#yonghuIdNumber').val() != "" && jquery('#yonghuIdNumber').val() != "null" ) {
                param['yonghuIdNumber'] = jquery('#yonghuIdNumber').val();
            }
                                    // 获取列表数据
