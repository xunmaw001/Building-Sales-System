...
<div class="wrapper">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input id="kehuPhone" name="kehuPhone" class="form-control"
                                           onchange="kehuPhoneChickValue(this)"  placeholder="手机号">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>身份证号</label>
                                    <input id="kehuIdNumber" name="kehuIdNumber" class="form-control"
                                           onchange="kehuIdNumberChickValue(this)"  placeholder="身份证号">
                                </div>
                                   <div class="form-group col-md-12">
                                       <label>头像</label>
                                       <img id="kehuPhotoImg" src="" width="100" height="100">
                                       <input name="file" type="file" id="kehuPhotoupload"
                                              class="form-control-file">
                                       <input name="kehuPhoto" id="kehuPhoto-input" type="hidden">
                                   </div>
                                   <div class="form-group col-md-12">
                                       <label>性别</label>
    ...
    <script>
        ...
        $('#kehuPhotoupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                var photoUrl= baseUrl + 'file/download?fileName=' + data.result.file;
                document.getElementById('kehuPhotoImg').setAttribute('src',photoUrl);
                document.getElementById('kehuPhoto-input').setAttribute('value',photoUrl);
            }
        });
        ...
        function submit() {
            ...
            if (validform() == true && compare() == true) {
                ...
                var urlParam;
                var successMes = '';
                httpJson("kehu/register", "POST", data, (res) => {
                    if(res.code == 0){
        ...
        //数字检查
        <!-- 当前表的数字检查 -->
        function kehuPhoneChickValue(e){
        ...
        function kehuIdNumberChickValue(e){
            var this_val = e.value || 0;
