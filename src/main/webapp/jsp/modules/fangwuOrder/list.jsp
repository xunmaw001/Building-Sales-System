...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">房屋订单管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">房屋订单列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">房屋订单列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <select name="fangwuOrderTypesSelectSearch"  style="width: 150px;" id="fangwuOrderTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if( kehuIdNumberSearchInput != null){
                ...
                //订单类型
            var fangwuOrderTypesSelectSearchInput = document.getElementById("fangwuOrderTypesSelectSearch");
            if(fangwuOrderTypesSelectSearchInput != null){
                var fangwuOrderTypesIndex = fangwuOrderTypesSelectSearchInput.selectedIndex;
                if( fangwuOrderTypesIndex  != 0){
                    searchForm.fangwuOrderTypes= document.getElementById("fangwuOrderTypesSelectSearch").options[fangwuOrderTypesIndex].value;
                }
            }
                        getDataList();
        }
        ...
        function getDataList() {
            http("fangwuOrder/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                //本表的
                fangwuOrderTypes: searchForm.fangwuOrderTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //订单类型
            var fangwuOrderTypesCell = document.createElement('td');
            fangwuOrderTypesCell.innerHTML = item.fangwuOrderValue;
            row.appendChild(fangwuOrderTypesCell);


            //预约看房时间
            var fangwuOrderTimeCell = document.createElement('td');
            fangwuOrderTimeCell.innerHTML = item.fangwuOrderTime;
            row.appendChild(fangwuOrderTimeCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("fangwuOrder/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addfangwuOrder", "addfangwuOrder");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
        ...
        function fangwuOrderTypesSelectSearch() {
            var fangwuOrderTypesSelectSearch = document.getElementById('fangwuOrderTypesSelectSearch');
            if(fangwuOrderTypesSelectSearch != null) {
                fangwuOrderTypesSelectSearch.add(new Option('-请选择-',''));
                if (fangwuOrderTypesOptions != null && fangwuOrderTypesOptions.length > 0){
                    for (var i = 0; i < fangwuOrderTypesOptions.length; i++) {
                            fangwuOrderTypesSelectSearch.add(new Option(fangwuOrderTypesOptions[i].indexName,fangwuOrderTypesOptions[i].codeIndex));
                    }
                }
            }
        }
    ...
    //查询当前表搜索条件所有列表
            function fangwuOrderTypesSelect() {
                //填充下拉框选项
                http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=fangwu_order_types", "GET", {}, (res) => {
                    if(res.code == 0){
                        fangwuOrderTypesOptions = res.data.list;
                    }
                });
            }
