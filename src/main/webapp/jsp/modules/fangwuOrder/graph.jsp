...
<script>
    ...
    function getDetails() {
		// "/sum/group/jingying/jingying_types/jingying_money"  对应 /sum/group/{tableName}/{groupColumn}/{sumCloum}   tableName表名 groupColumn分组列  sumCloum  求和列
        //填充下拉框选项
        http("/count/group/fangwu_order/fangwu_order_types", "GET", null, (res) => {
            if(res.code == 0){
            draw(res.data);
        }
    });
