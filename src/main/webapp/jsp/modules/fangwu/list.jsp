...
<!--/Pre Loader -->
    ...
    <!-- 本表的查询条件 -->
            ...
            var fangwuTimeStartSearch = $('#fangwuTimeStartSearch');
            if( fangwuTimeStartSearch != null){
                if (fangwuTimeStartSearch.val() != null && fangwuTimeStartSearch.val() != '') {
                    searchForm.fangwuTimeStart = $('#fangwuTimeStartSearch').val();
                }
            }
            var fangwuTimeEndSearch = $('#fangwuTimeEndSearch');
            if( fangwuTimeEndSearch != null){
                if (fangwuTimeEndSearch.val() != null && fangwuTimeEndSearch.val() != '') {
                    searchForm.fangwuTimeEnd = $('#fangwuTimeEndSearch').val();
                }
            }
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("fangwu/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addfangwu", "addfangwu");
            window.location.href = "add-or-update.jsp"
        }
